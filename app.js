...
var randomImg = function(){
  return productArr[Math.floor(Math.random() * pictures.length)];
};
console.log(randomImg().pathWay)
var imageOne = document.getElementById('image-one');
imageOne.setAttribute('src', randomImg().pathWay);

var imageTwo = document.getElementById('image-two');
imageTwo.setAttribute('src', randomImg().pathWay);

var imageThree = document.getElementById('image-three');
imageThree.setAttribute('src', randomImg().pathWay);
